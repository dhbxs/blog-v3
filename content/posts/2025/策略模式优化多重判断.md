...
```java [GetStringStrategyAImpl.java]
...
```java [GetStringStrategyBImpl.java]
import demo.GetStringStrategy;
...
```java [GetStringStrategyCImpl.java]
import demo.GetStringStrategy;
...
```java [GetStringStrategyFactory.java]
package demo;
...
>
> [https://cloud.tencent.com/developer/support-plan?invitecode=1uukf1hgh3yq0](https://cloud.tencent.com/developer/support-plan?invite_code=1uukf1hgh3yq0)
